...
<jsp:include page="header.jsp"></jsp:include>
  ...
  <div class="row">
  	...
  	<form action="<%=request.getContextPath() %>/keyword" method="post" style="background:#DEEAEF ">
  	
  	
  	<div class="row" style="padding-top: 20px">
  		<div class="col-md-1"></div>
  		<div class="col-md-8">
  		<label style="padding-top: 8px"><span style="color:#319AC4; font-size: 16pt;" >ADD key words</span></label>
  		</div>
  		...
  		<div class="col-md-7">
  		<select class="dropdown"  name="Cat_ID" required>
  	...
  	<div class="row" style="padding-top: 20px">
  		<div class="col-md-1"></div>
  		<div class="col-md-3">
  		<label style="padding-top: 8px; color:#319AC4; ">Keyword:</label>
  		</div>
  		<div class="col-md-7">
